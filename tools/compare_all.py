...
def merge_visualization(agent_dir, baseline_dir, gt_dir, out_dir, filename):
    ...
    for frame in frames:
        ...
        im_concat = cv2.vconcat([im2, im1, im3])
...
if __name__ == "__main__":
    ...
    gt_dir = '/home/dchipping/project/dan-track/videos/gt_images/MOT17/val_half/MOT17-09'

    merge_visualization(agent_dir, baseline_dir, gt_dir, out_dir, filename)
