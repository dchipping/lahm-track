...
class opts(object):
  def __init__(self):
    ...
    # exp name
    self.parser.add_argument('--exp_name', type=str, default='baseline-{}'.format(
    ...
    #
    self.parser.add_argument('--last_100', default=False, help='short test seq')
    self.parser.add_argument('--MOT17_05', default=False, help='short test seq')
    self.parser.add_argument('--agent_path', default='2, 3',
                            help='-1 for CPU, use comma for multiple gpus')
    #
